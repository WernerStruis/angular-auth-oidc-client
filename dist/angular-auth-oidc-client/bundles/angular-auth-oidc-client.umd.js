(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var PlatformProvider = /** @class */ (function () {
        ...
        /** @nocollapse */
        PlatformProvider.ctorParameters = function () {
            return [
    ...
    var ConfigurationProvider = /** @class */ (function () {
        function ConfigurationProvider(platformProvider) {
            ...
            this.onConfigurationChangeInternal = new rxjs.Subject();
        }
        ...
        /** @nocollapse */
        ConfigurationProvider.ctorParameters = function () {
            return [
                { type: PlatformProvider }
            ];
        };
        /** @nocollapse */ ConfigurationProvider.ngInjectableDef = i0.defineInjectable({ factory: function ConfigurationProvider_Factory() { return new ConfigurationProvider(i0.inject(PlatformProvider)); }, token: ConfigurationProvider, providedIn: "root" });
    ...
    var OidcConfigService = /** @class */ (function () {
        function OidcConfigService(loggerService, httpClient) {
            this.loggerService = loggerService;
            this.httpClient = httpClient;
            this.configurationLoadedInternal = new rxjs.ReplaySubject(1);
        }
         ...
         */
            function (clientConfig) {
                ...
                return this.httpClient.get(url).pipe(operators.switchMap(( /**
                 * @param {?} wellKnownEndpoints
                 * @return {?}
                 */function (wellKnownEndpoints) {
                    _this.configurationLoadedInternal.next({
    ...
    var OidcSecurityService = /** @class */ (function () {
        function OidcSecurityService(oidcDataService, stateValidationService, router$$1, oidcSecurityCheckSession, oidcSecuritySilentRenew, oidcSecurityUserService, oidcSecurityCommon, oidcSecurityValidation, tokenHelperService, loggerService, zone, httpClient, configurationProvider, urlParserService) {
             ...
             */function () {
                 ...
                 * @return {?}
                 */function () { return true; }))), rxjs.timer(_this.configurationProvider.openIDConfiguration.isauthorizedrace_timeout_in_seconds * 1000).pipe(
         ...
         */
            function (code, state, sessionState) {
                var _this = this;
                return this._isModuleSetup.pipe(operators.filter(( /**
                 * @param {?} isModuleSetup
                 * @return {?}
                 */function (isModuleSetup) { return !!isModuleSetup; })), operators.take(1), operators.switchMap(( /**
                 * @return {?}
                 */function () {
            ...
            function () {
                if (this.configurationProvider.wellKnownEndpoints) {
                    ...
                    return this.oidcDataService
                        ...
                        .pipe(operators.catchError(this.handleErrorGetSigningKeys));
                }
                else {
    ...
    exports.ɵc = OidcDataService;
    exports.ɵa = ConfigurationProvider;
    exports.ɵh = IFrameService;
    exports.ɵf = EqualityHelperService;
    exports.ɵd = StateValidationService;
    exports.ɵg = OidcSecurityCheckSession;
    exports.ɵe = OidcSecurityCommon;
    exports.ɵi = OidcSecuritySilentRenew;
    exports.ɵj = OidcSecurityUserService;
    exports.ɵb = PlatformProvider;
    exports.ɵk = UrlParserService;
